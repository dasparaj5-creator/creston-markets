...
- Location: tests\admin\referral-engine.spec.ts:227:7

# Error details

```
Error: locator.getAttribute: Error: strict mode violation: locator('select').first().locator('option').filter({ hasText: /Test Chain F/i }) resolved to 43 elements:
