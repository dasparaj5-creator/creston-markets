...
- Location: tests\admin\referral-engine.spec.ts:203:7

# Error details

```
Error: locator.getAttribute: Error: strict mode violation: locator('select').first().locator('option').filter({ hasText: /Test Chain F/i }) resolved to 50 elements:
